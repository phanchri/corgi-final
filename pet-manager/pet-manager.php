...
Text Domain: wp_pet
Domain Path: /lang
Plugin URI: http://nkcp.com/pet-manager
Description: Pet Manager offers a easy way to sort through available puppies
Version: 1.0
Author: Natasha Kee, Christina Phan
...
class PET_MANAGER {
  ...
  function petmanager_setup(){
    ...
    // Shortcode implementation for the form
